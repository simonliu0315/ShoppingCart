...
public class ExcelReportCustomView extends AbstractXlsView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		header.createCell(0).setCellValue("客戶編號");
		header.createCell(1).setCellValue("客戶名稱");
		header.createCell(2).setCellValue("客戶簡稱");
		header.createCell(3).setCellValue("業務編號");
		header.createCell(4).setCellValue("客戶類別");
		header.createCell(5).setCellValue("負責人");

		header.createCell(6).setCellValue("聯絡人1");
		header.createCell(7).setCellValue("電話1");
		header.createCell(8).setCellValue("大哥大1");
		header.createCell(9).setCellValue("聯絡人2");
		header.createCell(10).setCellValue("電話2");
		header.createCell(11).setCellValue("大哥大2");
		header.createCell(12).setCellValue("傳真機");
		header.createCell(13).setCellValue("統編");
		header.createCell(14).setCellValue("營業稅(1.外加稅 2.內含稅 3.零稅 4.免稅)");
		header.createCell(15).setCellValue("發票種類(1.三聯 2.二聯 3.收銀 空白)");
		header.createCell(16).setCellValue("公司郵地區號");
		header.createCell(17).setCellValue("公司地址");
		header.createCell(18).setCellValue("發票郵遞區號");
		header.createCell(19).setCellValue("發票地址");
		header.createCell(20).setCellValue("送貨郵遞區號");
		header.createCell(21).setCellValue("送貨地址");
		
		header.createCell(22).setCellValue("電子信箱");
		header.createCell(23).setCellValue("自定欄位一");
		header.createCell(24).setCellValue("自定欄位二");
		header.createCell(25).setCellValue("自定欄位三");
		header.createCell(26).setCellValue("自定欄位四");
		header.createCell(27).setCellValue("自定欄位五");
		header.createCell(28).setCellValue("自定欄位六");
		header.createCell(29).setCellValue("自定欄位七");
		header.createCell(30).setCellValue("自定欄位八");
		header.createCell(31).setCellValue("自定欄位九");
		header.createCell(32).setCellValue("自定欄位十");
